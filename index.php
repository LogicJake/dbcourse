...
// white list
$actionList = ['insertStu','insertSc','insertCourse','deleteStu','deleteSc','deleteCourse','selectStuAll','getStu','selectCourse','selectScByCno',
'selectScBySno','selectCourseStatus','updateCourse','updateStu','updateGrade','login','selectStu'];
